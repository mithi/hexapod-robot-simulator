...
HEXAPOD_FIGURE = {
    'data': [{'line': {'color': '#8e44ad', 'width': 10},
              'name': 'body',
              'showlegend': True,
              'type': 'scatter3d',
             ...
             {'line': {'color': '#2c3e50', 'width': 10},
              ...
              'y': [100, 170.71067811865476, 241.42135623730948,
                    241.42135623730948],
              'z': [0, 0.0, 0.0, -100.0]},
             {'line': {'color': '#2c3e50', 'width': 10},
              'name': 'leg',
              ...
              'x': [-100, -170.71067811865476, -241.42135623730948,
                    -241.42135623730948],
             ...
             {'line': {'color': '#2c3e50', 'width': 10},
              ...
              'x': [-100, -200.0, -300.0, -300.0],
              'y': [0, 1.2246467991473532e-14, 2.4492935982947064e-14,
             ...
             {'line': {'color': '#2c3e50', 'width': 10},
              ...
              'x': [-100, -170.71067811865476, -241.42135623730954,
                    -241.42135623730954],
              'y': [-100, -170.71067811865476, -241.42135623730948,
                    -241.42135623730948],
              'z': [0, 0.0, 0.0, -100.0]},
             {'line': {'color': '#2c3e50', 'width': 10},
              ...
              'x': [100, 170.71067811865476, 241.42135623730948,
                    241.42135623730948],
              'y': [-100, -170.71067811865476, -241.42135623730954,
                    -241.42135623730954],
              'z': [0, 0.0, 0.0, -100.0]}],
    'layout': {'legend': {'x': 0, 'y': 0},
               'margin': {'b': 20, 'l': 10, 'r': 10, 't': 20},
               'scene': {'aspectmode': 'manual',
                         'aspectratio': {'x': 1, 'y': 1, 'z': 1},
                         'camera': {'center': {'x': -0.05, 'y': 0, 'z': -0.1},
                         ...
                         'zaxis': {'backgroundcolor': 'rgb(230, 230, 2005)',
                                   'nticks': 1,
                                   'range': [-600, 600],
                                   'showbackground': True}},
               'template': '...'}
